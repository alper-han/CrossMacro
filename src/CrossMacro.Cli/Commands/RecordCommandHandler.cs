...
public sealed class RecordCommandHandler(IRecordExecutionService recordExecutionService, ICliPreflightService cliPreflightService) : CliCommandHandlerBase<RecordCliOptions>
{
