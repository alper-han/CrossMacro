...
internal static class TextExpansionExecutionTimings
{
    ...
    public static readonly TimeSpan DirectTypingNewLineDelay = TimeSpan.FromMilliseconds(5);
    public static readonly TimeSpan DirectTypingInterElementDelay = TimeSpan.FromMilliseconds(1);
    public static readonly TimeSpan LinuxUnicodeComposeActivationDelay = TimeSpan.FromMilliseconds(200);
    public static readonly TimeSpan LinuxUnicodeComposeInterKeyDelay = TimeSpan.FromMilliseconds(5);
    public static readonly TimeSpan LinuxUnicodeComposeCompletionDelay = TimeSpan.FromMilliseconds(20);
    public static readonly TimeSpan KeyPressReleaseDelay = TimeSpan.FromMilliseconds(15);
