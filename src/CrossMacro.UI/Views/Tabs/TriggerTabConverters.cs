...
public static class TriggerTabConverters
{
    ...
    public static readonly IValueConverter IsSwitchProfileConverter =
        new FuncValueConverter<TriggerAction, bool>(action => action == TriggerAction.SwitchProfile);

    public static readonly IValueConverter IsRunMacroConverter =
        new FuncValueConverter<TriggerAction, bool>(action => action == TriggerAction.RunMacro);
    ...
    public static readonly IValueConverter NeedsMatchValueConverter =
        new FuncValueConverter<TriggerField, bool>(field => field != TriggerField.None);
