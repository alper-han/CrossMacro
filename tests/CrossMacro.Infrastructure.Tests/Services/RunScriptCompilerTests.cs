...
public sealed class RunScriptCompilerTests
{
    ...
    [InlineData("imageclick 0 0 100 100 Target clicked click_x click_y button right timeout 5000 similarity 0.9")]
    [InlineData("waitimage Target timeout 5000")]
    [InlineData("waitimage 0 0 100 100 Target found x y timeout 5000 similarity 0.9")]
    ...
    [InlineData("imagesearch region 0 0 0 10 TargetImage", "Invalid imagesearch region")]
    [InlineData("imageclick region 0 nope 10 10 TargetImage", "Invalid imageclick region")]
    ...
    [InlineData("imagesearch TargetImage downsample 2", "Unknown imagesearch option")]
    [InlineData("imagesearch TargetImage scaleaware", "Unknown imagesearch option")]
    [InlineData("imagesearch TargetImage matchmode first matchmode best", "Duplicate imagesearch matchmode")]
    [InlineData("imagesearch TargetImage poll poll", "Unknown imagesearch option")]
    ...
    [InlineData("pixelcolor 1 2 sampled timeout 0", "Invalid pixelcolor syntax")]
    [InlineData("pixelsearch 0 0 10 10 123456 poll 0", "Unknown pixelsearch option")]
    [InlineData("imagesearch TargetImage poll nope", "Unknown imagesearch option")]
    [InlineData("imagesearch TargetImage timeout 0", "Unknown imagesearch option")]
    [InlineData("waitcolor 1 2 FF0000 1000 wait_ok poll 0", "Invalid waitcolor syntax")]
    ...
    [InlineData("pixelsearch 0 0 10 10 123456 found found_x found_y timeout 5000 tolerance 26")]
    [InlineData("pixelsearch 0 0 10 10 $sampled found found_x found_y tolerance 10")]
    [InlineData("imagesearch TargetImage")]
    [InlineData("imagesearch region found found_x found_y")]
    [InlineData("imagesearch region $found found_x found_y")]
    ...
    [InlineData("imagesearch 0 0 10 10 TargetImage found found_x found_y similarity 0.85")]
    [InlineData("imagesearch region $x $y $width $height TargetImage found found_x found_y similarity 0.85")]
    [InlineData("imageclick region $x $y 100 100 TargetImage button right timeout 5000")]
    [InlineData("waitimage region $x $y 100 $height TargetImage found found_x found_y timeout 5000")]
    [InlineData("imageclick TargetImage button right timeout 5000")]
    [InlineData("waitimage TargetImage found found_x found_y timeout 5000")]
