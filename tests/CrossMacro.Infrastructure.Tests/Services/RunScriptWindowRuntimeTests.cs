...
public sealed class RunScriptWindowRuntimeTests
{
    ...
    [InlineData("window focus class Terminal", null)]
    [InlineData("window close class Terminal", "Unknown field")]
    [InlineData("window focus active extra", "Syntax")]
    [InlineData("window close active extra", "Syntax")]
    [InlineData("window focus title", "Missing value")]
    [InlineData("window close address", "Missing value")]
